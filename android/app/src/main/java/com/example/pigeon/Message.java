...
public class Message {
    ...
    public static class Book {
        ...
        public static final class Builder {
            ...
            public @NonNull
            Builder setTitle(@Nullable String setterArg) {
                this.title = setterArg;
                return this;
            }
            ...
            public @NonNull
            Builder setAuthor(@Nullable String setterArg) {
                this.author = setterArg;
                return this;
            }
        ...
        static @NonNull
        Book fromList(@NonNull ArrayList<Object> list) {
        ...
        static void setup(BinaryMessenger binaryMessenger, BookApi api) {
            {
                ...
                Log.i("BookApi", "setMessageHandler setup");
                if (api != null) {
                    Log.i("BookApi", "setMessageHandler");
                    channel.setMessageHandler((message, reply) -> {
                        Log.i("BookApi", "setMessageHandler inner");
